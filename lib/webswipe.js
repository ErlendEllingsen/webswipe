...
var webswipe = function(userOptsObj){
    ...
    this.init = function(userOptsObj) {
        ...
        if (isTouchDevice) {
            ...
            motherDOM.addEventListener('touchstart', this.triggers.triggerDown);
            motherDOM.addEventListener('touchmove', this.triggers.triggerMove);
            
            motherDOM.addEventListener('touchend', this.triggers.triggerUp);
            motherDOM.addEventListener('touchcancel', this.triggers.triggerUp);
    ...
    this.setPage = function(DOMReference, callback, useHistory) {
        ...
        if (pageActive != null && useHistory !== false) {
            ...
            if (pagePrevious.nodeName != undefined) pagePrevious.innerHTML = '';
            pagePrevious = null;
        }
    ...
    this.triggers.triggerDown = function(e) {
        ...
        triggerMoveStartX = self.tools.getCurrentX(e);
